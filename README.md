...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/simplegmail-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15140&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/simplegmail-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `simplegmail` can be installed with:

```
conda install simplegmail
```

It is possible to list all of the versions of `simplegmail` available on your platform with:
