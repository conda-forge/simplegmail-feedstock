...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/simplegmail-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/simplegmail-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add simplegmail
# for installing globally
pixi global install simplegmail
```
...
It is possible to list all of the versions of `simplegmail` available on your platform:
...
```
pixi search simplegmail --channel conda-forge
```
